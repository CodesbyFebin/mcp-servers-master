 ...
 * Path: /blog/mcp-server-for-event-driven-architecture
...
const PATH = "/blog/mcp-server-for-event-driven-architecture";
const TITLE = "Mcp Server For Event Driven Architecture";
