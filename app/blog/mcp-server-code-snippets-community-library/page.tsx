 ...
 * Path: /blog/mcp-server-code-snippets-community-library
...
const PATH = "/blog/mcp-server-code-snippets-community-library";
const TITLE = "Mcp Server Code Snippets Community Library";
