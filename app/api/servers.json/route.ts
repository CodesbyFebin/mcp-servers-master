...
/**
 * /api/servers.json — alias of /registry.json (same payload, same authority).
 *
 * Provided because some MCP discovery tooling expects a /api/servers.json
 * path. The implementation delegates to the same cohort derivation as
 * /registry.json; do NOT diverge the two.
 */
