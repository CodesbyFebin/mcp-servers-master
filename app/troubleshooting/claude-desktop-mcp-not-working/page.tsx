 ...
 * Path: /troubleshooting/claude-desktop-mcp-not-working
...
const PATH = "/troubleshooting/claude-desktop-mcp-not-working";
const TITLE = "Claude Desktop Mcp Not Working";
